...
#define MATCH_MTMTP 0x200006b
#define MASK_MTMTP  0xfe00707f
#define MATCH_VDOT_VV 0xe0000057
#define MASK_VDOT_VV  0xfc00707f

#define MATCH_VFDOT_VV 0xe4004057
...
/*mtmtp*/
DECLARE_INSN(mtmtp, MATCH_MTMTP, MASK_MTMTP)
